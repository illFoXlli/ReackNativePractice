...
const RegistrationScreen = () => {
  ...
  const [closePass, onClosePass] = React.useState(true);
  ...
  //   const onClose = () => onClosePass(prevClose => !prevClose);
  ...
  return (
    <TouchableWithoutFeedback onPress={keyboarHide}>
      <View style={styles.container}>
        ...
        >
          <View
            style={{ ...styles.form, paddingBottom: !isShowKeyboard ? 45 : 32 }}
          >
            <KeyboardAvoidingView
            ...
            >
              <View style={styles.divPhoto}>
                <TouchableWithoutFeedback
                  onPress={() => onClosePass(!closePass)}
                >
                  <View
                    style={{
                      ...styles.buttonClose,
                      borderColor: closePass ? '#FF6C00' : '#E8E8E8',
                    }}
                  >
                    <View
                      style={{
                        ...styles.buttonCloseHorizon,
                        transform: closePass
                          ? [{ rotateZ: '0deg' }]
                          : [{ rotateZ: '45deg' }],
                        backgroundColor: closePass ? '#FF6C00' : '#E8E8E8',
                      }}
                    />

                    <View
                      style={{
                        ...styles.buttonCloseVertical,
                        transform: closePass
                          ? [{ rotateZ: '90deg' }]
                          : [{ rotateZ: '135deg' }],
                        backgroundColor: closePass ? '#FF6C00' : '#E8E8E8',
...
const styles = StyleSheet.create({
  ...
  buttonClose: {
    ...
    button: 0,
    right: 0,
    transform: [{ translateX: 12.5 }, { translateY: 81 }],
    // zIndex: 100,
    width: 25,
    height: 25,
    borderRadius: 100,
